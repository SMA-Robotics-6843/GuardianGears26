...
public class ShootOnTheMoveCommand extends Command {
  ...
  public ShootOnTheMoveCommand(SwerveDriveSubsystem drivetrain, Superstructure superstructure,
  ...
  public void execute() {
    ...
    var threeDPose = new Pose3d(drivetrain.getPose());
    var shooterLocation = threeDPose.getTranslation()
    ...
    Logger.recordOutput("ShootOnTheMove/RobotHeading", drivetrain.getState().RawHeading);
